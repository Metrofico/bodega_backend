...
from app_usbodega.graphql.Inputs import InputUpdateCargo, InputRegisterCargo, InputDeleteCargo
from app_usbodega.graphql.objetos.ObjectsTypes import CargosType
